...
export default function AuthShell({ children, cardClassName = 'max-w-sm' }) {
  return (
    <div
      className="flex min-h-screen items-center justify-center bg-accent bg-cover bg-center px-4 py-12"
      style={{ backgroundImage: `url(${campusBackground})` }}
    >
      <div className={`w-full rounded-2xl bg-card p-8 text-center shadow-2xl ${cardClassName}`}>
